...
class VirtualPhantom():
    ...
    def create_artefact_ROI_region(self, width = 10):
    ...
    def create_background_ROI_region(self, margin = 15):
        background_ROI_region = np.zeros([self.img_size, self.img_size], dtype = np.float64)
        background_ROI_region[margin : self.top_outer, margin:self.top_outer] = 1
        background_ROI_region[self.img_size-self.top_outer : self.img_size - margin , margin:self.top_outer] = 1
        background_ROI_region[margin:self.top_outer, self.img_size-self.top_outer : self.img_size-margin] = 1
        background_ROI_region[self.img_size-self.top_outer : self.img_size-margin , self.img_size-self.top_outer : self.img_size-margin] = 1
